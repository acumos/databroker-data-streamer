...
public class MessageRouterTask implements  Runnable {
	...
	private static final String CODE_CLOUD_AUTHORIZATION2 = "CodeCloud-Authorization";
	...
	protected String executePredictorScoring(String authorization,  
		...
		String codeCloudAuthorization = predictDetails.getString(CODE_CLOUD_AUTHORIZATION);
	    aHttpURLConnection.setRequestProperty(CODE_CLOUD_AUTHORIZATION2, codeCloudAuthorization);
