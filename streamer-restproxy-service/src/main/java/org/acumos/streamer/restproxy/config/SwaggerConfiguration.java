...
import org.acumos.streamer.restproxy.DataStreamerRestProxyApplication;
...
public class SwaggerConfiguration {
	...
	private ApiInfo apiInfo() {
		final String version = DataStreamerRestProxyApplication.class.getPackage().getImplementationVersion();
