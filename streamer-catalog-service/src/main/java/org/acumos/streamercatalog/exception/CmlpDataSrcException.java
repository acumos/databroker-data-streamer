...
package org.acumos.streamercatalog.exception;

import javax.ws.rs.core.Response;
import javax.ws.rs.core.Response.Status;

import org.acumos.streamercatalog.model.ErrorModel;
...
public class CmlpDataSrcException extends Exception {
	 ...
	 */
	public CmlpDataSrcException(String Message) {
		super(Message);
	}
	
	public CmlpDataSrcException(String Message, int code) {
		super(Message);
		this._code = code;
	}
