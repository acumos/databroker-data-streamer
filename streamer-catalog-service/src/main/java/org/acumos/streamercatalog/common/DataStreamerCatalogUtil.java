...
public class DataStreamerCatalogUtil {
	...
	private static final String PLEASE_PROVIDE_CODE_CLOUD_AUTHORIZATION_HEADER = "Please provide CodeCloudAuthorization header";
	private static final String PLEASE_PROVIDE_A_PREDICTOR = "Please provide a predictor";
	...
	public static void validateRequest(String user, String codeCloudAuthorization, CatalogObject objCatalog) throws DataStreamerException, Exception {
		...
		if (!(objCatalog.getPredictorId() != null) || objCatalog.getPredictorId().isEmpty()) {
			throw new DataStreamerException(PLEASE_PROVIDE_A_PREDICTOR, 400);
		}

		if (!(codeCloudAuthorization != null) || codeCloudAuthorization.isEmpty()) {
			throw new DataStreamerException(PLEASE_PROVIDE_CODE_CLOUD_AUTHORIZATION_HEADER, 400);
		}
