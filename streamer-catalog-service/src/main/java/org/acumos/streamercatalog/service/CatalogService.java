...
public interface CatalogService {
	 ...
	 */
	public String saveCatalog(String user, String authorization, CatalogObject objCatalog) throws IOException, DataStreamerException;
	 ...
	 * 				Custom Exception for the application.
	 */
	public String updateCatalog(String user, String authorization,  String catalogKey, CatalogObject objCatalog) throws IOException, DataStreamerException;
