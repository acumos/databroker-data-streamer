...
public class CatalogObject {
	...
	private MessageRouterDetails messageRouterDetails;
	/**
	 ...
	 */
	public MessageRouterDetails getMessageRouterDetails() {
		return messageRouterDetails;
	}
	/**
	 * @param messageRouterDetails the messageRouterDetails to set
	 */
	public void setMessageRouterDetails(MessageRouterDetails messageRouterDetails) {
