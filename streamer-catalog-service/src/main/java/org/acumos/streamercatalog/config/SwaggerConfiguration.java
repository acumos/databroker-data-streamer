...
import org.acumos.streamercatalog.DataStreamerCatalogApplication;
...
public class SwaggerConfiguration {
	...
	private ApiInfo apiInfo() {
		final String version = DataStreamerCatalogApplication.class.getPackage().getImplementationVersion();
		return new ApiInfoBuilder() //
				.title("Acumos DataStreamerCatalog Service REST API") //
				.description("Provides create, retrieve, update and delete (CRUD) services for catalogs " //
